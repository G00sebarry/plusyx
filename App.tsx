  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden tg-bg select-none relative">
      ...
      <TaskModal 
        ...
        columns={columns} 
      />
      <HabitModal isOpen={isHabitModalOpen || (!!editingHabit && !!editingHabit.id)} onClose={() => { setIsHabitModalOpen(false); setEditingHabit(undefined); }} onSave={editingHabit?.id ? handleUpdateHabit : handleAddHabit} initialHabit={editingHabit} userId={userId || undefined} isTelegramUser={!!window.Telegram?.WebApp?.initDataUnsafe?.user} />
